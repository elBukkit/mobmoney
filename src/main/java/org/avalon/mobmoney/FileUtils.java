...
public class FileUtils {
	...
	public static void updateConfig() {
		...
		try {
			FileConfiguration cfg = YamlConfiguration.loadConfiguration(configlist);
			int u = 0;
			if (!cfg.isSet("main.double_event")) { cfg.set("main.double_event", false); u++; }
			if (!cfg.isSet("main.ChanceToDropMoney")){ cfg.set("main.ChanceToDropMoney", 100);  u++; }
			if (!cfg.isSet("World_Blacklist")){ cfg.set("World_Blacklist", Arrays.asList("world1", "world2")); u++; }
			
			if (u != 0) System.out.println("[MobMoney] Updated " + u + " lines in your configuration.");
